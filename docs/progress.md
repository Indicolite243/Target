...
状态：对话、账户工具、回测、业绩归因和用户私有知识库 RAG 已完成第一版；MCP 待开始。

- Spring Boot 负责 JWT 用户边界、会话和消息持久化、受控 Function Calling、持仓/归因/回测冻结快照，以及私有知识文档和证据追溯。
...
- 当前回归基线：Spring Boot 43 项、Vue 14 项、FastAPI 41 项测试通过，Vue 生产构建通过。
